...
interface AmplitudeSustainProps {
  onChange: (value: number) => void;
}

export function AmplitudeSustain({ onChange }: AmplitudeSustainProps) {
  const sustain = useSynthStore((s) => s.parameters.amplitude.sustain);
